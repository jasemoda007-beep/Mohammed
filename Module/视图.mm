...
namespace menu {
    namespace ESP {
        ...
        extern bool enemy_count;
        extern bool ESPMob;
        extern float items_scale;

        extern ImColor v_espcolor;
        extern ImColor nv_espcolor;
        extern ImColor nickcolor;
        extern ImColor hprcolor;
        extern ImColor hpr1color;
        extern ImColor hprkcolor;
        extern ImColor itemcolor;
        extern ImColor distcolor;
        extern ImColor weapcolor;
        extern ImColor infocolor;
        extern ImColor linecolor;
        extern ImColor v_skelcolor;
        extern ImColor nv_skelcolor;
        extern ImColor v_hpcolor;
        extern ImColor nv_hpcolor;
        extern ImColor v_backcolor;
        extern ImColor nv_backvolor;
        extern ImColor hpbotcolor;
        extern ImColor hpbot1color;
        extern ImColor RPIVbone;
        extern ImColor RPVbone;
        extern ImColor BIVbone;
        extern ImColor BVbone;
    }
    namespace aimbot {
        extern bool aimbot;
        extern bool silent;
...
extern float aimbotCoord_x;//aimbot line draw
extern float aimbotCoord_y;//aimbot line draw
...
-(void)drawDrawWindow {
    ...
    readFrameData(ImVec2(screenSize.width / 2,screenSize.height / 2),playerDataList, materialDataList);
        //activate memory patch like player fly and speed ..etc
    
        //draw aimbot line
        /*
        if(aimbotCoord_x != 0 && aimbotCoord_y != 0){
            imDrawList->AddLine({static_cast<float>(screenSize.width / 2), static_cast<float>(screenSize.height / 2)}, {aimbotCoord_x, aimbotCoord_y}, ImColor(255, 255, 255), 2.0f);//Ineed Bool in Aimbot only
            //NSLog(@"start drawing");
        }
         */
        for (MaterialData materialData:materialDataList) {
            //Determine whether it is on screen
            if (self.moduleControl->playerSwitch.WZWZStatus) {
                if (materialData.name=="[Early Warning] Beware of grenades") {//Warning sticker
                ...
                if (materialData.name=="[Bombing Warning] Beware of bombing areas") {
                ...
                if (materialData.distance != -100){
                    ...
                    if (materialData.name=="three wheel motorcycle") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    if (materialData.name=="little sheep") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    if (materialData.name=="bouncing") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="Ofune") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    if (materialData.name=="motorboat") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    if (materialData.name=="baby bus") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    if (materialData.name=="armored vehicle") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="Snow heavy motorcycle") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 206, 209), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="smoke bomb") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 127, 80), 21, str.c_str());
                    }
                    if (materialData.name=="Molotov cocktail") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 127, 80), 21, str.c_str());
                    }
                    if (materialData.name=="Level 3 Armor") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="Level 3 package") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="Level 3 Helmet") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="oil barrel") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="holographic") {
                        std::string str =  "["+ materialData.name +":" + std::to_string(materialData.distance) + "M]";
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(70, 130, 180), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[medicine] painkillers") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[medicine] epinephrine") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[medicine] drinks") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[medicine] first aid kit") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[medicine] medical kit") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 210, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Defense] Level 3 Armor") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Package]Level 3 package") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[head]Level 3 helmet") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Defense] Level 2 Armor") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Package] Level 2 package") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[head]Level 2 helmet") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[sniper]Mosin Nagant") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 0, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[Machine] DP-28") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 69, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Machine] M249") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 69, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Machine]MG3") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 69, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[Bullet] Magnum") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 255, 0), 21, str.c_str());
                    }
                    if (materialData.name=="[Bullet] Flare") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(0, 255, 0), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[scope] holographic") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(70, 130, 180), 21, str.c_str());
                    }
                    ...
                    if (materialData.name=="[throw] smoke bombs") {
                        std::string str = materialData.name;
                        imDrawList->AddTextX(ImVec2(materialData.screen.x+1 - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y+1), ImColor(0, 0, 0, 255), 21, str.c_str());
                        imDrawList->AddTextX(ImVec2(materialData.screen.x - calcTextSize(str.c_str(), 21) / 2, materialData.screen.y), ImColor(255, 127, 80), 21, str.c_str());
                    }
            ...
            if (self.moduleControl->playerSwitch.WZStatus) {
                ...
                if (materialData.name=="S12K") {
                    imDrawList->AddImage((__bridge ImTextureID) S12KTexture, ImVec2(materialData.screen.x+165 - scWidth+1, materialData.screen.y+17 -  scHeight+1), ImVec2(materialData.screen.x+165 - scWidth+1 + scHeight-2 , materialData.screen.y+17 - scHeight + scHeight-1), ImVec2(0.0f, 0.0f), ImVec2(1.0f, 1.0f));
                }
                if (materialData.name=="DBS") {
                    imDrawList->AddImage((__bridge ImTextureID) DBSTexture, ImVec2(materialData.screen.x+165 - scWidth+1, materialData.screen.y+17 -  scHeight+1), ImVec2(materialData.screen.x+165 - scWidth+1 + scHeight-2 , materialData.screen.y+17 - scHeight + scHeight-1), ImVec2(0.0f, 0.0f), ImVec2(1.0f, 1.0f));
                }
                if (materialData.name=="AKM") {
                ...
                if (materialData.distance != -100) {
                    ...
                    std::string str = materialData.name + ":";//Materials in the box
        ...
        if (self.moduleControl->mainSwitch.playerStatus) {
            ...
            //Clear the number of people
            int playerCount = 0, robotCount = 0;
            for (PlayerData playerData:playerDataList) {
                //The number of humans and machines and the number of real people
                ImColor color, color150;
                if (!playerData.robot) {//real person
                    if (playerData.visibility) {
                        color = ImColor(menu::ESP::RPVbone);//visible
                    } else {
                        color = ImColor(menu::ESP::RPIVbone);//Invisible
                    }
                    playerCount += 1;
                } else {
                    if (playerData.visibility) {
                        color = ImColor(menu::ESP::BVbone);//visible
                    } else {
                        color = ImColor(menu::ESP::BIVbone);//Invisible
                    }
                    robotCount += 1;
                }
                //Radar UI
                if (self.moduleControl->playerSwitch.radarStatus) {//dots
                ...
                //Determine whether it is within the screen
                if (playerData.screen.x - hpWidth < screenSize.width && playerData.screen.x + hpWidth > 0 &&
                    playerData.screen.y > 0 && playerData.screen.y < screenSize.height) {
                    ...
                    if (self.moduleControl->playerSwitch.infoStatus) {
                        ...
                        if (!playerData.robot) {
                            ...
                            float hpPercentage = playerData.hp / 100.0f;
                            float adjustedBarWidth = barWidth * hpPercentage;

                            // 顶点计算
                            points[0] = { playerData.screen.x - 4 - hpWidth + moveRight, playerData.screen.y - playerData.size.y - 15 - hpHeight };
                            points[1] = { playerData.screen.x - 4 - hpWidth + adjustedBarWidth + moveRight, playerData.screen.y - playerData.size.y - 15 - hpHeight };
                            points[2] = { playerData.screen.x - 4 - hpWidth + adjustedBarWidth + barHeight / 2 + moveRight, playerData.screen.y - playerData.size.y - 15 };
                            points[3] = { playerData.screen.x - 4 - hpWidth + adjustedBarWidth + moveRight, playerData.screen.y - playerData.size.y - 15 + barHeight };
                            points[4] = { playerData.screen.x - 4 - hpWidth + moveRight, playerData.screen.y - playerData.size.y - 15 + barHeight };
                            points[5] = { playerData.screen.x - 4 - hpWidth - barHeight / 2 + moveRight, playerData.screen.y - playerData.size.y - 15 };

                            // 设置颜色
                            ImColor healthColor;
                            if (playerData.visibility) {
                                healthColor = ImColor(menu::ESP::hprcolor);
                            } else {
                                healthColor = ImColor(menu::ESP::hpr1color);
                            }

                            // 绘制六边形血条
                            imDrawList->AddConvexPolyFilled(points, 6, healthColor);
                            imDrawList->AddPolyline(points, 6, ImColor(255, 255, 255, 120), true, 1.0f);
                            ...
                            ImColor healthColor;
                            if (playerData.visibility) {
                                healthColor = ImColor(menu::ESP::hpbotcolor);
                            } else {
                                healthColor = ImColor(menu::ESP::hpbot1color);
                            }
                        ...
                        if (self.moduleControl->playerSwitch.SCStatus) {
                            ...
                            if (playerData.weaponName=="[SG]S686") {
                            ...
                            if (playerData.weaponName=="[SG]DBS") {
                            ...
                            if (playerData.weaponName=="[SG]S12K") {
                            ...
                            if (playerData.weaponName=="[AR]QBZ") {
                            ...
                            if (playerData.weaponName=="[AR]M416") {
                            ...
                            if (playerData.weaponName=="[SR]QBU") {
                            ...
                            if (playerData.weaponName=="[SR]SLR") {
                            ...
                            if (playerData.weaponName=="[SR]SKS") {
                            ...
                            if (playerData.weaponName=="[SR]Mini14") {
                            ...
                            if (playerData.weaponName=="[SR]Mk14") {
                            ...
                            if (playerData.weaponName=="[SR]Mosin Nagant") {
                            ...
                            if (playerData.weaponName=="[SR]VSS") {
                            ...
                            if (playerData.weaponName=="[AR]M762") {
                            ...
                            if (playerData.weaponName=="[AR]SCAR-L") {
                            ...
                            if (playerData.weaponName=="[AR]M16A4") {
                            ...
                            if (playerData.weaponName=="[AR]Mk47") {
                            ...
                            if (playerData.weaponName=="[AR]Groza") {
                            ...
                            if (playerData.weaponName=="[AR]AUG") {
                            ...
                            if (playerData.weaponName=="[AR]AKM") {
                            ...
                            if (playerData.weaponName=="[thrown object] grenade") {
                            ...
                            if (playerData.weaponName=="[thrown object] smoke bomb") {
                            ...
                            if (playerData.weaponName=="[Throwing object] Molotov cocktail") {
                            ...
                            if (playerData.weaponName=="[SMG]P92") {
                ...
                } else if (self.moduleControl->playerSwitch.backStatus) {//Early warning of defection from the enemy
                    ImVec2 backAngle = rotateCoord(playerData.angle,ImVec2(320, 0));
                    ImVec2 backAngle1 = rotateCoord(playerData.angle, ImVec2(162.5, 0));
                    
                    ImVec2 triangle1 = rotateCoord(playerData.angle - 150, ImVec2(15, 0));
                    triangle1.x += screenSize.width / 2 + backAngle.x;
                    triangle1.y += screenSize.height / 2 + backAngle.y;
                    
                    ImVec2 triangle2 = rotateCoord(playerData.angle, ImVec2(25, 0));
                    triangle2.x += screenSize.width / 2 + backAngle.x;
                    triangle2.y += screenSize.height / 2 + backAngle.y;
                    
                    ImVec2 triangle3 = rotateCoord(playerData.angle + 150, ImVec2(15, 0));
                    triangle3.x += screenSize.width / 2 + backAngle.x;
                    triangle3.y += screenSize.height / 2 + backAngle.y;
                    
                    ImVec2 triangle4 = rotateCoord(playerData.angle - 100, ImVec2(15, 0));
                    triangle4.x += screenSize.width / 2 + backAngle.x;
                    triangle4.y += screenSize.height / 2 + backAngle.y;
                    
                    ImVec2 triangle5 = rotateCoord(playerData.angle, ImVec2(25, 0));
                    triangle5.x += screenSize.width / 2 + backAngle.x;
                    triangle5.y += screenSize.height / 2 + backAngle.y;
                    
                    ImVec2 triangle6 = rotateCoord(playerData.angle + 100, ImVec2(15, 0));
                    triangle6.x += screenSize.width / 2 + backAngle.x;
                    triangle6.y += screenSize.height / 2 + backAngle.y;
                    
                    // Calculate center of the triangle for text placement
                    ImVec2 textCenter;
                    textCenter.x = (triangle1.x + triangle2.x + triangle3.x) / 3;
                    textCenter.y = (triangle1.y + triangle2.y + triangle3.y) / 3;
                    
                    if(playerData.hp <= 0) {
                        imDrawList->AddTriangleFilled(triangle1, triangle2, triangle3, ImColor(255,165,0));
                        imDrawList->AddTriangleFilled(triangle4, triangle5, triangle6, ImColor(255,165,0));
                        } else {
                        imDrawList->AddTriangleFilled(triangle1, triangle2, triangle3, color);
                        imDrawList->AddTriangleFilled(triangle4, triangle5, triangle6, color);
                    }
                    
                    std::string str = std::to_string(playerData.distance);
                    float textWidth = calcTextSize(str.c_str(), 30);
                    
                    if (!playerData.robot) {
                        if (color == ImColor(255, 255, 0)) {
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2 + 1.5, textCenter.y - 7), ImColor(0, 0, 0, 255), 30, str.c_str());
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2, textCenter.y - 8.5), ImColor(255, 0, 0), 30, str.c_str());
                    } else {
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2 + 1.5, textCenter.y - 7), ImColor(0, 0, 0, 255), 30, str.c_str());
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2, textCenter.y - 8.5), ImColor(255, 255, 0), 30, str.c_str());
                        }
                            } else {
                        if (color == ImColor(0, 255, 0)) {
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2 + 1.5, textCenter.y - 8), ImColor(0, 0, 0, 255), 30, str.c_str());
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2, textCenter.y - 9.5), ImColor(255, 255, 255), 30, str.c_str());
                        } else {
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2 + 1.5, textCenter.y - 8), ImColor(0, 0, 0, 255), 30, str.c_str());
                            imDrawList->AddTextX(ImVec2(textCenter.x - textWidth/2, textCenter.y - 9.5), ImColor(0, 255, 0), 30, str.c_str());
                        }
                    }
                }
            }
            
            //imDrawList->AddTextX(ImVec2((screenSize.width / 2) - 100, 50), ImColor(0, 0, 0), 61,"ALKHAL");
            //imDrawList->AddTextX(ImVec2((screenSize.width / 2) - 100, 50), ImColor(255, 255, 255), 59, "ALKHAL");
...
//            } else {
//                if(robotCount == 0){//人machine Yellow warning
...
//                }else{
//                    imDrawList->AddTextX(ImVec2(screenSize.width / 2 + 36.5, 101.5 + countTexture.height / 2 - 20), ImColor(0, 0, 0, 255),45, std::to_string(robotCount).c_str());
//                    imDrawList->AddTextX(ImVec2(screenSize.width / 2 + 35, 100 + countTexture.height / 2 - 20), ImColor(255, 165, 0), 45, std::to_string(robotCount).c_str());
...
//                }
//                if(playerCount == 0){//Live red warning
...
//       }
    if (playerCount != 0 || robotCount != 0) {
        int totalPlayers = playerCount + robotCount;
        std::string str_pl = "Total Enemies: " + std::to_string(totalPlayers);
        
        ImGuiIO& io = ImGui::GetIO();
        ImDrawList* draw_list = ImGui::GetBackgroundDrawList();
        
        ImVec2 textSize = ImGui::CalcTextSize(str_pl.c_str());
        ImVec2 textPos = ImVec2((io.DisplaySize.x - textSize.x) / 2.0f, 80.0f);
        ...
        draw_list->AddRectFilled(rectMin, rectMax, ImColor(0, 0, 0, 180), 5.0f); // Rounded dark background
        draw_list->AddText(textPos, ImColor(255, 255, 255), str_pl.c_str());
    }
}
...
-(void)initImageTexture: (id<MTLDevice>)device {
    NSData *LancerData = [[NSData alloc] initWithBase64EncodedString:LancerDataBase64 options:NSDataBase64DecodingIgnoreUnknownCharacters];
    LancerTexture = [self loadImageTexture : device : (void*)[LancerData bytes] : [LancerData length]];
